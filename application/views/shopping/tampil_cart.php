...
<form action="<?php echo base_url()?>shopping/ubah_cart" method="post" name="frmShopping" id="frmShopping" class="formhorizontal" enctype="multipart/form-data">
  ...
  <tr>
    <td><?php echo $i++; ?></td>
    <td>
      <img class="img-responsive" src="<?php echo base_url() . 'assets/images/'.$item['gambar']; ?>"/ width="200px">
    </td>
    ...
    <td>
      <a href="<?php echo base_url()?>shopping/hapus/<?php echo $item['rowid'];?>" class="btn btn-sm btn-danger">
